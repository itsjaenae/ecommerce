...
class CreateExtraSettingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('extra_settings', function (Blueprint $table) {
            ...
            $table->tinyInteger('is_t3_specialpick')->default(1)->nullable();
            ...
            $table->tinyInteger('is_t1_flash')->default(1)->nullable();
            $table->tinyInteger('is_t2_flash')->default(1)->nullable();
            $table->tinyInteger('is_t3_flash')->default(1)->nullable();
            $table->tinyInteger('is_t4_flash')->default(1)->nullable();
