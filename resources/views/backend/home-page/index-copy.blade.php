	...
	<div class="card shadow mb-4">
		<div class="card-body">
            <div class="row">
                ...
                {{-- the banner beside the slider in theme 1 --}}
                            ...
                            <form class="admin-form" action="{{route('admin.first.banner.update')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                src="{{isset($first_banner['img1']) ? asset('images/home_page_images/'.$first_banner['img1']) : asset('assets/images/placeholder.png') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="firsturl1" class="form-control" id="firsturl1"
                                                ...
                                                value="{{isset($first_banner['firsturl1']) ? $first_banner['firsturl1'] : ''}}" >
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                src="{{isset($first_banner['img2']) ? asset('images/home_page_images/'.$first_banner['img2']) : asset('assets/images/placeholder.png') }}"
                                               alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="firsturl2" class="form-control" id="firsturl2"
                                                placeholder="{{ __('Enter Banner Url') }}" 
                                                value="{{isset($first_banner['firsturl2']) ? $first_banner['firsturl2'] : ''}}"
                                                 >
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                src="{{isset($first_banner['img3']) ? asset('images/home_page_images/'.$first_banner['img3']) : asset('assets/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="firsturl3" class="form-control" id="firsturl3"
                                                placeholder="{{ __('Enter Banner Url') }}"
                                                value="{{isset($first_banner['firsturl3']) ? $first_banner['firsturl3'] : ''}}"
                                               >
                                        </div>
                                ...
                                @csrf
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="popular_title" class="form-control" id="popular_title"
                                            placeholder="{{ __('Popular Category') }}"
                                            value="{{isset($popular_category['popular_title']) ? $popular_category['popular_title'] : ''}}" >
                                    </div>
                                    <hr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="childcategory_id1" id="childcategory_id1" class="form-control">
                                            ...
                                            <option value="{{ $chieldcategory->id }}" {{ $chieldcategory->id == $popular_category['childcategory_id1'] ? 'selected' : '' }}>{{ $chieldcategory->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="childcategory_id2" id="childcategory_id2" class="form-control">
                                            ...
                                            <option value="{{ $chieldcategory->id }}" {{ $chieldcategory->id == $popular_category['childcategory_id2'] ? 'selected' : '' }}>{{ $chieldcategory->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="childcategory_id3" id="childcategory_id3" class="form-control">
                                            ...
                                            <option value="{{ $chieldcategory->id }}" {{ $chieldcategory->id == $popular_category['childcategory_id3'] ? 'selected' : '' }}>{{ $chieldcategory->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="childcategory_id4" id="childcategory_id4" class="form-control">
                                            ...
                                            <option value="{{ $chieldcategory->id }}" {{ $chieldcategory->id == $popular_category['childcategory_id4'] ? 'selected' : '' }}>{{ $chieldcategory->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <form class="admin-form" action="{{route('admin.second.banner.update')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                src="{{isset($second_banner['img1']) ? asset('images/home_page_images/'.$first_banner['img1']) : asset('assets/images/placeholder.png') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="url1" class="form-control" id="url1"
                                                placeholder="{{ __('Enter Banner Url') }}" 
                                                value="{{isset($second_banner['url1']) ? $second_banner['url1'] : ''}}">
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                src="{{isset($second_banner['img2']) ? asset('images/home_page_images/'.$first_banner['img2']) : asset('assets/images/placeholder.png') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="url2" class="form-control" id="url2"
                                                placeholder="{{ __('Enter Banner Url') }}"
                                                value="{{isset($second_banner['url2']) ? $second_banner['url2'] : ''}}" >
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                src="{{isset($second_banner['img3']) ? asset('images/home_page_images/'.$first_banner['img3']) : asset('assets/images/placeholder.png') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="url3" class="form-control" id="url3"
                                                placeholder="{{ __('Enter Banner Url') }}" 
                                                value="{{isset($second_banner['url3']) ? $second_banner['url3'] : ''}}">
                                        </div>
                            ...
                            <form class="admin-form" action="{{route('admin.tree.column.category.update')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="childcategory_id1"  id="cloumn_childcategory_id1" class="form-control">
                                        ...
                                        <option value="{{ $chieldcategory->id }}" {{ $chieldcategory->id == $three_column_category['childcategory_id1'] ? 'selected' : '' }}>{{ $chieldcategory->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="childcategory_id2" id="cloumn_childcategory_id2" class="form-control">
                                        ...
                                        <option value="{{ $chieldcategory->id }}" {{ $chieldcategory->id == $three_column_category['childcategory_id2'] ? 'selected' : '' }}>{{ $chieldcategory->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="childcategory_id3" id="cloumn_childcategory_id3" class="form-control">
                                        ...
                                        <option value="{{ $chieldcategory->id }}" {{isset($three_column_category['category_id3']) &&  $chieldcategory->id == $three_column_category['childcategory_id3'] ? 'selected' : '' }}>{{ $chieldcategory->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <form class="admin-form" action="{{route('admin.feature.category.update')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="childcategory_id1" id="feature_childcategory_id1" class="form-control">
                                        ...
                                        <option value="{{ $chieldcategory->id }}" {{ $chieldcategory->id == $feature_category['childcategory_id1'] ? 'selected' : '' }}>{{ $chieldcategory->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="childcategory_id2" id="feature_childcategory_id2" class="form-control">
                                        ...
                                        <option value="{{ $chieldcategory->id }}" {{ $chieldcategory->id == $feature_category['childcategory_id2'] ? 'selected' : '' }}>{{ $chieldcategory->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="childcategory_id3" id="feature_childcategory_id3" class="form-control">
                                        ...
                                        <option value="{{ $chieldcategory->id }}" {{ $chieldcategory->id == $feature_category['childcategory_id3'] ? 'selected' : '' }}>{{ $chieldcategory->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="childcategory_id4" id="feature_childcategory_id4" class="form-control">
                                        ...
                                        <option value="{{ $chieldcategory->id }}" {{ $chieldcategory->id == $feature_category['childcategory_id4'] ? 'selected' : '' }}>{{ $chieldcategory->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <form class="admin-form" action="{{route('admin.third.banner.update')}}"
                                ...
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                src="{{isset($third_banner['img1']) ? asset('images/home_page_images/'.$third_banner['img1']) : asset('assets/images/placeholder.png') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="url1" class="form-control" id="url1"
                                                placeholder="{{ __('Enter Banner Url') }}" 
                                                value="{{isset($third_banner['url1']) ? $third_banner['url1'] : ''}}">
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                src="{{isset($third_banner['img2']) ? asset('images/home_page_images/'.$third_banner['img2']) : asset('assets/images/placeholder.png') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="url2" class="form-control" id="url2"
                                                placeholder="{{ __('Enter Banner Url') }}" 
                                                value="{{isset($third_banner['url2']) ? $third_banner['url2'] : ''}}">
                                        </div>
