                ...
                <div class="col-7 col-md-9">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-t9" role="tabpanel" aria-labelledby="v-pills-t9-tab">
                            <form class="admin-form" action="{{route('admin.hero.banner.update')}}"method="POST" enctype="multipart/form-data">
                                ...
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{isset($hero_banner['img1']) ? asset('images/home_page_images/'.$hero_banner['img1']) : asset('assets/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{isset($hero_banner['img2']) ? asset('images/home_page_images/'.$hero_banner['img2']) : asset('assets/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                        ...
                        <div class="tab-pane fade show " id="v-pills-t1" role="tabpanel" aria-labelledby="v-pills-t1-tab">
                            <form class="admin-form" action="{{route('admin.first.banner.update')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        <div class="form-group">
                                            <label for="name">{{ __('Image 1') }} *</label>
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('images/home_page_images/'.$first_banner['img1']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('images/home_page_images/'.$first_banner['img2']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('images/home_page_images/'.$first_banner['img3']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                    ...
                                    <div class="form-group">
                                            <button type="submit" class="btn btn-secategory_id1condary ">{{ __('Submit') }}</button>
                                </div>
                            </form>
                        </div>
                        <div class="tab-pane fade" id="v-pills-t2" role="tabpanel" aria-labelledby="v-pills-t2-tab">

                            <form class="admin-form" action="{{route('admin.popular.category.update')}}" method="POST">
                                @csrf
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_id1"  id="category_id1" data-h class="form-control" >
                                            <option value="" >{{__('Select One')}}</option>
                                            @foreach(DB::table('categories')->whereStatus(1)->get() as $cat)
                                            <option value="{{ $cat->id }}" {{$cat->id == $popular_category['category_id1'] ? 'selected' : ''}} >{{ $cat->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="subcategory_id1">{{ __('Select Sub Category') }} </label>
                                        <select name="subcategory_id1" id="subcategory_id1" class="form-control" data-h>
                                            <option value="">{{__('Select one')}}</option>
                                            @foreach(DB::table('subcategories')->where('category_id',$popular_category['category_id1'])->whereStatus(1)->get() as $subcat)
                                            <option value="{{ $subcat->id }}" {{ $subcat->id == $popular_category['subcategory_id1']? 'selected' : '' }}>{{ $subcat->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="childcategory_id1" id="childcategory_id1" class="form-control">
                                            <option value="">{{__('Select one')}}</option>
                                            @foreach(DB::table('child_categories')->where('category_id',$popular_category['category_id1'])->whereStatus(1)->get() as $childcategory)
                                            <option value="{{ $childcategory->id }}" {{ $childcategory->id == $popular_category['childcategory_id1'] ? 'selected' : '' }}>{{ $childcategory->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_id2" id="category_id2" data-h class="form-control" >
                                            <option value="" >{{__('Select One')}}</option>
                                            @foreach(DB::table('categories')->whereStatus(1)->get() as $cat)
                                            <option value="{{ $cat->id }}" {{$cat->id == $popular_category['category_id2'] ? 'selected' : ''}}>{{ $cat->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="subcategory_id2">{{ __('Select Sub Category') }} </label>
                                        <select name="subcategory_id2" id="subcategory_id2" class="form-control" data-h>
                                            <option value="">{{__('Select one')}}</option>
                                            @foreach(DB::table('subcategories')->where('category_id',$popular_category['category_id2'])->whereStatus(1)->get() as $subcat)
                                            <option value="{{ $subcat->id }}" {{ $subcat->id == $popular_category['subcategory_id2']? 'selected' : '' }}>{{ $subcat->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="childcategory_id2" id="childcategory_id2" class="form-control">
                                            <option value="">{{__('Select one')}}</option>
                                            @foreach(DB::table('child_categories')->where('category_id',$popular_category['category_id2'])->whereStatus(1)->get() as $childcategory)
                                            <option value="{{ $childcategory->id }}" {{ $childcategory->id == $popular_category['childcategory_id2'] ? 'selected' : '' }}>{{ $childcategory->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_id3" id="category_id3" data-h class="form-control" >
                                            <option value="" >{{__('Select One')}}</option>
                                            @foreach(DB::table('categories')->whereStatus(1)->get() as $cat)
                                            <option value="{{ $cat->id }}" {{$cat->id == $popular_category['category_id3'] ? 'selected' : ''}} >{{ $cat->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="subcategory_id3">{{ __('Select Sub Category') }} </label>
                                        <select name="subcategory_id3" id="subcategory_id3" class="form-control" data-h>
                                            <option value="">{{__('Select one')}}</option>
                                            @foreach(DB::table('subcategories')->where('category_id',$popular_category['category_id3'])->whereStatus(1)->get() as $subcat)
                                            <option value="{{ $subcat->id }}" {{ $subcat->id == $popular_category['subcategory_id3']? 'selected' : '' }}>{{ $subcat->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="childcategory_id3" id="childcategory_id3" class="form-control">
                                            <option value="">{{__('Select one')}}</option>
                                            @foreach(DB::table('child_categories')->where('category_id',$popular_category['category_id3'])->whereStatus(1)->get() as $childcategory)
                                            <option value="{{ $childcategory->id }}" {{ $childcategory->id == $popular_category['childcategory_id3'] ? 'selected' : '' }}>{{ $childcategory->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_id4" id="category_id4" data-h class="form-control" >
                                            <option value="" >{{__('Select One')}}</option>
                                            @foreach(DB::table('categories')->whereStatus(1)->get() as $cat)
                                            <option value="{{ $cat->id }}" {{$cat->id == $popular_category['category_id4'] ? 'selected' : ''}}>{{ $cat->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="subcategory_id4">{{ __('Select Sub Category') }} </label>
                                        <select name="subcategory_id4" id="subcategory_id4" class="form-control" data-h>
                                            <option value="">{{__('Select one')}}</option>
                                            @foreach(DB::table('subcategories')->where('category_id',$popular_category['category_id4'])->whereStatus(1)->get() as $subcat)
                                            <option value="{{ $subcat->id }}" {{ $subcat->id == $popular_category['subcategory_id4']? 'selected' : '' }}>{{ $subcat->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="childcategory_id4" id="childcategory_id4" class="form-control">
                                            <option value="">{{__('Select one')}}</option>
                                            @foreach(DB::table('child_categories')->where('category_id',$popular_category['category_id4'])->whereStatus(1)->get() as $childcategory)
                                            <option value="{{ $childcategory->id }}" {{ $childcategory->id == $popular_category['childcategory_id4'] ? 'selected' : '' }}>{{ $childcategory->name_en}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-t5" role="tabpanel" aria-labelledby="v-pills-t5-tab">
                            <form class="admin-form" action="{{route('admin.second.banner.update')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        <div class="form-group">
                                            <label for="name">{{ __('Image 1') }} *</label>
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('images/home_page_images/'.$second_banner['img1']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="title1">{{ __('Title') }} *</label>
                                            <input type="text" name="title1" class="form-control" id="title1"
                                                placeholder="{{ __('Enter Title') }}"  value="{{isset($second_banner['title1']) ? $second_banner['title1'] : ''}}" >
                                        </div>
                                        <div class="form-group">
                                            <label for="subtitle1">{{ __('Subtitle') }} *</label>
                                            <input type="text" name="subtitle1" class="form-control" id="subtitle1"
                                                placeholder="{{ __('Enter Subtitle') }}"  value="{{isset($second_banner['subtitle1']) ? $second_banner['subtitle1'] : ''}}" >
                                        </div>

                                        <div class="form-group">
                                            <label for="url">{{ __('URL 1') }} *</label>
                                            <input type="text" name="url1" class="form-control" id="url1"
                                                placeholder="{{ __('Enter Banner Url') }}" value="{{$second_banner['url1']}}" >
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('images/home_page_images/'.$second_banner['img2']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="title2">{{ __('Title') }} *</label>
                                            <input type="text" name="title2" class="form-control" id="title2"
                                                placeholder="{{ __('Enter Title') }}"  value="{{isset($second_banner['title2']) ? $second_banner['title2'] : ''}}" >
                                        </div>
                                        <div class="form-group">
                                            <label for="subtitle2">{{ __('Subtitle') }} *</label>
                                            <input type="text" name="subtitle2" class="form-control" id="subtitle2"
                                                placeholder="{{ __('Enter Subtitle') }}"  value="{{isset($second_banner['subtitle2']) ? $second_banner['subtitle2'] : ''}}" >
                                        </div>

                                        <div class="form-group">
                                            <label for="url">{{ __('URL 2') }} *</label>
                                            <input type="text" name="url2" class="form-control" id="url2"
                                                placeholder="{{ __('Enter Banner Url') }}" value="{{$second_banner['url2']}}" >
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('images/home_page_images/'.$second_banner['img3']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="title3">{{ __('Title') }} *</label>
                                            <input type="text" name="title3" class="form-control" id="title3"
                                                placeholder="{{ __('Enter Title') }}"  value="{{isset($second_banner['title3']) ? $second_banner['title3'] : ''}}" >
                                        </div>
                                        <div class="form-group">
                                            <label for="subtitle3">{{ __('Subtitle') }} *</label>
                                            <input type="text" name="subtitle3" class="form-control" id="subtitle3"
                                                placeholder="{{ __('Enter Subtitle') }}"  value="{{isset($second_banner['subtitle3']) ? $second_banner['subtitle3'] : ''}}" >
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="url3" class="form-control" id="url3"
                                                placeholder="{{ __('Enter Banner Url') }}" value="{{$second_banner['url3']}}" >
                                        </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-t3" role="tabpanel" aria-labelledby="v-pills-t3-tab">
                            <form class="admin-form" action="{{route('admin.tree.column.category.update')}}" method="POST">
                                @csrf
                                <hr>
                                <h2 class=""><b>{{ __('Category 1 :') }}</b></h2>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id1" id="column_category_id1" data-h class="form-control" >
                                        <option value="" >{{__('Select One')}}</option>
                                        @foreach(DB::table('categories')->whereStatus(1)->get() as $cat)
                                        <option value="{{ $cat->id }}" {{$cat->id == $three_column_category['category_id1'] ? 'selected' : ''}} >{{ $cat->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="cloumn_subcategory_id2">{{ __('Select Sub Category') }} </label>
                                    <select name="subcategory_id1" id="cloumn_subcategory_id1" class="form-control" data-h>
                                        <option value="">{{__('Select one')}}</option>
                                        @foreach(DB::table('subcategories')->where('category_id',$three_column_category['category_id1'])->whereStatus(1)->get() as $subcat)
                                        <option value="{{ $subcat->id }}" {{ $subcat->id == $three_column_category['subcategory_id1']? 'selected' : '' }}>{{ $subcat->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="childcategory_id1"  id="cloumn_childcategory_id1" class="form-control">
                                        <option value="">{{__('Select one')}}</option>
                                        @foreach(DB::table('child_categories')->where('category_id',$three_column_category['category_id1'])->whereStatus(1)->get() as $childcategory)
                                        <option value="{{ $childcategory->id }}" {{ $childcategory->id == $three_column_category['childcategory_id1'] ? 'selected' : '' }}>{{ $childcategory->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id2" id="column_category_id2" data-h class="form-control" >
                                        <option value="" >{{__('Select One')}}</option>
                                        @foreach(DB::table('categories')->whereStatus(1)->get() as $cat)
                                        <option value="{{ $cat->id }}" {{$cat->id == $three_column_category['category_id2'] ? 'selected' : ''}}>{{ $cat->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="cloumn_subcategory_id2">{{ __('Select Sub Category') }} </label>
                                    <select name="subcategory_id2" id="cloumn_subcategory_id2" class="form-control" data-h>
                                        <option value="">{{__('Select one')}}</option>
                                        @foreach(DB::table('subcategories')->where('category_id',$three_column_category['category_id2'])->whereStatus(1)->get() as $subcat)
                                        <option value="{{ $subcat->id }}" {{ $subcat->id == $three_column_category['subcategory_id2']? 'selected' : '' }}>{{ $subcat->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="childcategory_id2" id="cloumn_childcategory_id2" class="form-control">
                                        <option value="">{{__('Select one')}}</option>
                                        @foreach(DB::table('child_categories')->where('category_id',$three_column_category['category_id2'])->whereStatus(1)->get() as $childcategory)
                                        <option value="{{ $childcategory->id }}" {{ $childcategory->id == $three_column_category['childcategory_id2'] ? 'selected' : '' }}>{{ $childcategory->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id3" id="column_category_id3" data-h class="form-control" >
                                        <option value="" >{{__('Select One')}}</option>
                                        @foreach(DB::table('categories')->whereStatus(1)->get() as $cat)
                                        <option value="{{ $cat->id }}" {{ isset($three_column_category['category_id3']) && $cat->id == $three_column_category['category_id3'] ? 'selected' : ''}}>{{ $cat->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="cloumn_subcategory_id3">{{ __('Select Sub Category') }} </label>
                                    <select name="subcategory_id3" id="cloumn_subcategory_id3" class="form-control" data-h>
                                        <option value="">{{__('Select one')}}</option>
                                        @php
                                        ...
                                        <option value="{{ $subcat->id }}" {{ isset($three_column_category['category_id3']) &&  $subcat->id == $three_column_category['subcategory_id3']? 'selected' : '' }}>{{ $subcat->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="childcategory_id3" id="cloumn_childcategory_id3" class="form-control">
                                        ...
                                        @php
                                            if(isset($three_column_category['category_id3'])){
                                                $childcategory = DB::table('child_categories')->where('category_id',$three_column_category['category_id3'])->whereStatus(1)->get();
                                            }else{
                                                $childcategory = DB::table('child_categories')->whereStatus(1)->get();
                                            }
                                        @endphp
                                        @foreach($childcategory as $childcategory)
                                        <option value="{{ $childcategory->id }}" {{isset($three_column_category['category_id3']) &&  $childcategory->id == $three_column_category['childcategory_id3'] ? 'selected' : '' }}>{{ $childcategory->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-t4" role="tabpanel" aria-labelledby="v-pills-t4-tab">
                            <form class="admin-form" action="{{route('admin.feature.category.update')}}" method="POST">
                                @csrf
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id1" id="feature_category_id1" data-h class="form-control" >
                                        <option value="" >{{__('Select One')}}</option>
                                        @foreach(DB::table('categories')->whereStatus(1)->get() as $cat)
                                        <option value="{{ $cat->id }}" {{$cat->id == $feature_category['category_id1'] ? 'selected' : ''}} >{{ $cat->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="feature_subcategory_id1">{{ __('Select Sub Category') }} </label>
                                    <select name="subcategory_id1" id="feature_subcategory_id1" class="form-control" data-h>
                                        <option value="">{{__('Select one')}}</option>
                                        @foreach(DB::table('subcategories')->where('category_id',$feature_category['category_id1'])->whereStatus(1)->get() as $subcat)
                                        <option value="{{ $subcat->id }}" {{ $subcat->id == $feature_category['subcategory_id1']? 'selected' : '' }}>{{ $subcat->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="childcategory_id1" id="feature_childcategory_id1" class="form-control">
                                        <option value="">{{__('Select one')}}</option>
                                        @foreach(DB::table('child_categories')->where('category_id',$feature_category['category_id1'])->whereStatus(1)->get() as $childcategory)
                                        <option value="{{ $childcategory->id }}" {{ $childcategory->id == $feature_category['childcategory_id1'] ? 'selected' : '' }}>{{ $childcategory->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id2" id="feature_category_id2" data-h class="form-control" >
                                        <option value="" >{{__('Select One')}}</option>
                                        @foreach(DB::table('categories')->whereStatus(1)->get() as $cat)
                                        <option value="{{ $cat->id }}" {{$cat->id == $feature_category['category_id2'] ? 'selected' : ''}}>{{ $cat->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="feature_subcategory_id2">{{ __('Select Sub Category') }} </label>
                                    <select name="subcategory_id2" id="feature_subcategory_id2" class="form-control" data-h>
                                        <option value="">{{__('Select one')}}</option>
                                        @foreach(DB::table('subcategories')->where('category_id',$feature_category['category_id2'])->whereStatus(1)->get() as $subcat)
                                        <option value="{{ $subcat->id }}" {{ $subcat->id == $feature_category['subcategory_id2']? 'selected' : '' }}>{{ $subcat->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="childcategory_id2" id="feature_childcategory_id2" class="form-control">
                                        <option value="">{{__('Select one')}}</option>
                                        @foreach(DB::table('child_categories')->where('category_id',$feature_category['category_id2'])->whereStatus(1)->get() as $childcategory)
                                        <option value="{{ $childcategory->id }}" {{ $childcategory->id == $feature_category['childcategory_id2'] ? 'selected' : '' }}>{{ $childcategory->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id3" id="feature_category_id3" data-h class="form-control" >
                                        <option value="" >{{__('Select One')}}</option>
                                        @foreach(DB::table('categories')->whereStatus(1)->get() as $cat)
                                        <option value="{{ $cat->id }}" {{$cat->id == $feature_category['category_id3'] ? 'selected' : ''}} >{{ $cat->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="feature_subcategory_id3">{{ __('Select Sub Category') }} </label>
                                    <select name="subcategory_id3" id="feature_subcategory_id3" class="form-control" data-h>
                                        <option value="">{{__('Select one')}}</option>
                                        @foreach(DB::table('subcategories')->where('category_id',$feature_category['category_id3'])->whereStatus(1)->get() as $subcat)
                                        <option value="{{ $subcat->id }}" {{ $subcat->id == $feature_category['subcategory_id3']? 'selected' : '' }}>{{ $subcat->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="childcategory_id3" id="feature_childcategory_id3" class="form-control">
                                        <option value="">{{__('Select one')}}</option>
                                        @foreach(DB::table('child_categories')->where('category_id',$feature_category['category_id3'])->whereStatus(1)->get() as $childcategory)
                                        <option value="{{ $childcategory->id }}" {{ $childcategory->id == $feature_category['childcategory_id3'] ? 'selected' : '' }}>{{ $childcategory->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id4" id="feature_category_id4" data-h class="form-control" >
                                        <option value="" >{{__('Select One')}}</option>
                                        @foreach(DB::table('categories')->whereStatus(1)->get() as $cat)
                                        <option value="{{ $cat->id }}" {{$cat->id == $feature_category['category_id4'] ? 'selected' : ''}}>{{ $cat->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="feature_subcategory_id4">{{ __('Select Sub Category') }} </label>
                                    <select name="subcategory_id4" id="feature_subcategory_id4" class="form-control" data-h>
                                        <option value="">{{__('Select one')}}</option>
                                        @foreach(DB::table('subcategories')->where('category_id',$feature_category['category_id4'])->whereStatus(1)->get() as $subcat)
                                        <option value="{{ $subcat->id }}" {{ $subcat->id == $feature_category['subcategory_id4']? 'selected' : '' }}>{{ $subcat->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="childcategory_id4" id="feature_childcategory_id4" class="form-control">
                                        <option value="">{{__('Select one')}}</option>
                                        @foreach(DB::table('child_categories')->where('category_id',$feature_category['category_id4'])->whereStatus(1)->get() as $childcategory)
                                        <option value="{{ $childcategory->id }}" {{ $childcategory->id == $feature_category['childcategory_id4'] ? 'selected' : '' }}>{{ $childcategory->name_en}}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-t6" role="tabpanel" aria-labelledby="v-pills-t6-tab">
                            <form class="admin-form" action="{{route('admin.third.banner.update')}}"
                                ...
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('images/home_page_images/'.$third_banner['img1']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{  asset('images/home_page_images/'.$third_banner['img2']) }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-t7" role="tabpanel" aria-labelledby="v-pills-t7-tab">
                            <form class="admin-form" action="{{route('admin.home_page4.banner.update')}}"method="POST" enctype="multipart/form-data">
                                @include('alerts.alerts')
                                @csrf
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img1']) ?  asset('images/home_page_images/'.$home4_banner['img1']) : asset('assets/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img2']) ?  asset('images/home_page_images/'.$home4_banner['img2']) : asset('assets/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img3']) ?  asset('images/home_page_images/'.$home4_banner['img3']) : asset('assets/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img4']) ?  asset('images/home_page_images/'.$home4_banner['img4']) : asset('assets/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                <img class="admin-img"
                                                    src="{{ isset($home4_banner['img5']) ?  asset('images/home_page_images/'.$home4_banner['img5']) : asset('assets/images/placeholder.png') }}"
                                                    alt="No Image Found">
                                            <br>
                                            <span class="mt-1">{{ __('Image Size Should Be 496 x 204.') }}</span>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-t8" role="tabpanel" aria-labelledby="v-pills-t8-tab">
                            <form class="admin-form" action="{{route('admin.home4.category.update')}}"
                                method="post" enctype="multipart/form-data">
                                @csrf
                                @php
                                ...
                                <select name="home_4_popular_category[]" id="basic" class="form-control" multiple data-h>
                                    @foreach(DB::table('categories')->whereStatus(1)->get() as $category)
                                    <option value="{{ $category->id }}" {{ in_array($category->id,$home_4_popular_category) ? 'selected' : '' }}>{{ $category->name_en}}</option>
                                    @endforeach
                                </select>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-secondary ">{{ __('Submit') }}</button>
...
<script>
    ...
    $('select[name="category_id1"]').on('change', function(){
        var category_id1 = $(this).val();
        if(category_id1) {
            $.ajax({
                url: "{{  url('/admin/subcategory/product/ajax') }}/"+category_id1,
                type:"GET",
                dataType:"json",
                success:function(data) {
                    $('select[name="childcategory_id1"]').html('');
                   var d =$('select[name="subcategory_id1"]').empty();
                      $.each(data, function(key, value){
                          $('select[name="subcategory_id1"]').append('<option value="'+ value.id +'">' + value.name_en + '</option>');
                      });
                },
            });
        } else {
...
$('select[name="subcategory_id1"]').on('change', function(){
        var subcategory_id1 = $(this).val();
        if(subcategory_id1) {
            $.ajax({
                url: "{{  url('/admin/childcategory/product/ajax') }}/"+subcategory_id1,
                type:"GET",
                dataType:"json",
                success:function(data) {
                   var d =$('select[name="childcategory_id1"]').empty();
                      $.each(data, function(key, value){
                          $('select[name="childcategory_id1"]').append('<option value="'+ value.id +'">' + value.name_en + '</option>');
                      });
                },
            });
        } else {
...
$(document).ready(function() {
    $('select[name="category_id2"]').on('change', function(){
        ...
        if(category_id2) {
            $.ajax({
                url: "{{  url('/admin/subcategory/product/ajax') }}/"+category_id2,
                type:"GET",
                dataType:"json",
                success:function(data) {
                    $('select[name="childcategory_id2"]').html('');
                   var d =$('select[name="subcategory_id2"]').empty();
                      $.each(data, function(key, value){
                          $('select[name="subcategory_id2"]').append('<option value="'+ value.id +'">' + value.name_en + '</option>');
                      });
                },
            });
        } else {
...
$('select[name="subcategory_id2"]').on('change', function(){
        var subcategory_id2 = $(this).val();
        if(subcategory_id2) {
            $.ajax({
                url: "{{  url('/admin/childcategory/product/ajax') }}/"+subcategory_id2,
                type:"GET",
                dataType:"json",
                success:function(data) {
                   var d =$('select[name="childcategory_id2"]').empty();
                      $.each(data, function(key, value){
                          $('select[name="childcategory_id2"]').append('<option value="'+ value.id +'">' + value.name_en + '</option>');
                      });
                },
            });
        } else {
...
$(document).ready(function() {
    $('select[name="category_id3"]').on('change', function(){
        var category_id3 = $(this).val();
        if(category_id3) {
            $.ajax({
                url: "{{  url('/admin/subcategory/product/ajax') }}/"+category_id3,
                type:"GET",
                dataType:"json",
                success:function(data) {
                    $('select[name="childcategory_id3"]').html('');
                   var d =$('select[name="subcategory_id3"]').empty();
                      $.each(data, function(key, value){
                          $('select[name="subcategory_id3"]').append('<option value="'+ value.id +'">' + value.name_en + '</option>');
                      });
                },
            });
        } else {
...
$('select[name="subcategory_id3"]').on('change', function(){
        var subcategory_id3 = $(this).val();
        if(subcategory_id3) {
            $.ajax({
                url: "{{  url('/admin/childcategory/product/ajax') }}/"+subcategory_id3,
                type:"GET",
                dataType:"json",
                success:function(data) {
                   var d =$('select[name="childcategory_id3"]').empty();
                      $.each(data, function(key, value){
                          $('select[name="childcategory_id3"]').append('<option value="'+ value.id +'">' + value.name_en + '</option>');
                      });
                },
            });
        } else {
...
$(document).ready(function() {
    $('select[name="category_id4"]').on('change', function(){
        var category_id4 = $(this).val();
        if(category_id4) {
            $.ajax({
                url: "{{  url('/admin/subcategory/product/ajax') }}/"+category_id4,
                type:"GET",
                dataType:"json",
                success:function(data) {
                    $('select[name="childcategory_id4"]').html('');
                   var d =$('select[name="subcategory_id4"]').empty();
                      $.each(data, function(key, value){
                          $('select[name="subcategory_id4"]').append('<option value="'+ value.id +'">' + value.name_en + '</option>');
                      });
                },
            });
        } else {
...
$('select[name="subcategory_id4"]').on('change', function(){
        var subcategory_id4 = $(this).val();
        if(subcategory_id4) {
            $.ajax({
                url: "{{  url('/admin/childcategory/product/ajax') }}/"+subcategory_id4,
                type:"GET",
                dataType:"json",
                success:function(data) {
                   var d =$('select[name="childcategory_id4"]').empty();
                      $.each(data, function(key, value){
                          $('select[name="childcategory_id4"]').append('<option value="'+ value.id +'">' + value.name_en + '</option>');
                      });
                },
            });
        } else {
