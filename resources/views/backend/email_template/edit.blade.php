    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                ...
                <a class="btn btn-primary btn-sm" href="{{route('admin.setting.email')}}"><i class="fas fa-chevron-left"></i> {{ __('Back') }}</a>
                </div>
        </div>
    </div>
			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					...
					<div class="row">
						...
						<div class="col-lg-6">
								<form class="admin-form" action="{{ route('admin.template.update',$template->id) }}"
