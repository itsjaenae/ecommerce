        ...
        <td>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="{{ route('admin.shipping.status',[$data->id,1]) }}">{{ __('Enable') }}</a>
                  <a class="dropdown-item" href="{{ route('admin.shipping.status',[$data->id,0]) }}">{{ __('Disable') }}</a>
                </div>
              </div>
        ...
        <td>
            <div class="action-list">
                <a class="btn btn-secondary btn-sm "
                    href="{{ route('admin.shipping.edit',[$data->id]) }}">
                    <i class="fas fa-edit"></i>
                </a>
                @if ($data->id != 1)
                <a class="btn btn-danger btn-sm " data-toggle="modal"
                    data-target="#confirm-delete" href="javascript:;"
                    data-href="{{ route('admin.shipping.destroy',[$data->id]) }}">
