...
@else
    <div class="row">
        <div class="col-sm-6 col-md-6">
            <a href="{{route('admin.product.create')}}" class="card card-stats card-round">
                <div class="card-body">
        ...
        <div class="col-sm-6 col-md-6">
            <a href="{{ route('admin.digital.product.create') }}" class="card card-stats card-round">
                <div class="card-body">
                    <div class="text-center py-3">
                        <div class="d-inline-block">
        ...
        <div class="col-sm-6 col-md-6">
            <a href="{{ route('admin.license.product.create') }}" class="card card-stats card-round">
                <div class="card-body">
                    <div class="text-center py-3">
                        <div class="d-inline-block">
        ...
        <div class="col-sm-6 col-md-6">
            <a href="{{ route('admin.affiliate.create') }}" class="card card-stats card-round">
                <div class="card-body">
                    <div class="text-center py-3">
                        <div class="d-inline-block">
                            <div class="icon-big text-center icon-success bubble-shadow-small  px-3">
