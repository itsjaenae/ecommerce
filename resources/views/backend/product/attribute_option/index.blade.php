       ...
       <div class="card-body">
        <div class="d-sm-flex align-items-center justify-content-between">
            ...
            <div>
                ...
                <a class="btn btn-primary btn-sm" href="{{ route('admin.option.create',$product->id) }}"><i class="fas fa-plus"></i> {{ __('Add Color') }}</a>
                <a class="btn btn-primary btn-sm" href="{{ route('admin.option.size',$product->id) }}"><i class="fas fa-plus"></i> {{ __('Add Size') }}</a>
            </div>
            </div>
       </div>
    </div>
		...
		<div class="card-body">
			...
			<div class="gd-responsive-table">
              ...
              <th width="20%">{{ __('Stock') }}</th>
					...
					<tbody>
                        @include('backend.product.attribute_option.table',compact('datas'))
					</tbody>
