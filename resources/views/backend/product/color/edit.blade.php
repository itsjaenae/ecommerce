			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('admin.color.update',[$color->id]) }}"
									method="POST" >
									...
									<div class="form-group">
										...
										<input type="text" name="color" class="form-control" id="attr_name"
											placeholder="{{ __('Enter Name') }}" value="{{ $color->color }}" >
									</div>

									<input type="hidden" id="attr_keyword" name="keyword" value="{{ $color->keyword }}">
