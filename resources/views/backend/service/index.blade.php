    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class=" mb-0"><b>{{ __('Services') }}</b></h3>
                <a class="btn btn-primary  btn-sm" href="{{route('admin.service.create')}}"><i class="fas fa-plus"></i> {{ __('Add') }}</a>
                </div>
        </div>
    </div>
		...
		<div class="card-body">
			...
			<div class="gd-responsive-table">
				<table class="table table-bordered table-striped" id="admin-table" width="100%" cellspacing="0">
					...
					<tbody>
                        @include('backend.service.table',compact('datas'))
					</tbody>
