        ...
        <td>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="{{ route('admin.page.pos',[$data->id,2]) }}">{{ __('Both') }}</a>
                  <a class="dropdown-item" href="{{ route('admin.page.pos',[$data->id,0]) }}">{{ __('Header') }}</a>
                  <a class="dropdown-item" href="{{ route('admin.page.pos',[$data->id,1]) }}">{{ __('Footer') }}</a>
                </div>
              </div>
        ...
        <td>
            <div class="action-list">
                ...
                <a class="btn btn-danger btn-sm btn-rounded" data-toggle="modal"
                    ...
                    data-href="{{ route('admin.page.destroy',[$data->id]) }}">
