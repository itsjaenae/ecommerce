...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        ...
        <h3 class="mb-0 bc-title"><b>{{ __('Update Social Link') }}</b> <a class="btn btn-primary btn-sm" href="{{route('admin.social.index')}}"><i class="fas fa-chevron-left"></i> {{ __('Back') }}</a></h3>
        <ol class="breadcrumb">
			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					...
					<div class="row justify-content-center">
						<div class="col-lg-8">
							<div class="p-5">
								<form class="admin-form" action="{{ route('admin.social.update',$social->id) }}"
