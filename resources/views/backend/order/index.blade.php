    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                ...
                <div class="right">
                <a href="{{route('admin.csv.order.export')}}" class="btn btn-info btn-sm d-inline-block">{{__('CSV Export')}}</a>
        ...
        <form action="{{route('admin.order.index')}}" method="GET">
          <div class="row mb-4 justify-content-center">
            ...
            <div class="col-lg-12 text-center mt-3">
                ...
                <a href="{{route('admin.order.index')}}" class="btn btn-info py-1">{{__('Reset')}}</a>
            </div>
        </div>
        </form>
