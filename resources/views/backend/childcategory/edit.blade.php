			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('admin.childcat.update',$childcategory->id) }}" method="POST"
                                    ...
                                    <div class="row">
										...
										<select name="category_id" id="category_id" class="form-control" >
											...
											<option value="{{ $cat->id }}" {{$cat->id == $childcategory->category_id  ? 'selected' :''}} >{{ $cat->name_en }}</option>
											@endforeach
										</select>
										 </div>
									</div>
									...
									<div class="form-group">
										...
										<select name="subcategory_id" id="subcategory_id" class="form-control">
											...
											<option value="{{ $subcat->id }}" {{ $subcat->id == $childcategory->subcategory_id ? 'selected' : '' }}>{{ $subcat->name_en }}</option>
											@endforeach
										</select>
									</div>
									</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" name="name_en" class="form-control item-name" id="name"
												placeholder="{{ __('Enter Name') }}" value="{{ $childcategory->name_en }}" >
										</div>
									</div>
										</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" name="name_hin" class="form-control item-name" id="name"
												placeholder="{{ __('Enter Name') }}" value="{{ $childcategory->name_hin }}" >
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" name="name_frn" class="form-control item-name" id="name"
												placeholder="{{ __('Enter Name') }}" value="{{ $childcategory->name_frn}}" >
										</div>
									</div>
										...
										<div class="form-group">
											...
											<input type="text" name="slug_en" class="form-control" id="slug"
												placeholder="{{ __('Enter Slug') }}" value="{{ $childcategory->slug_en }}" >
										</div>
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="form-group">
											...
											<input type="text" name="slug_hin" class="form-control" id="slug"
												placeholder="{{ __('Enter Slug') }}" value="{{ $childcategory->slug_hin}}" >
										</div>
										</div>
										...
										<div class="form-group">
											...
											<input type="text" name="slug_frn" class="form-control" id="slug"
												placeholder="{{ __('Enter Slug') }}" value="{{ $childcategory->slug_frn}}" >
										</div>
										</div>
									</div>
