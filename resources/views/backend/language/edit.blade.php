...
<div class="card mb-4">
    <div class="card-body">
        <div class="d-sm-flex align-items-center justify-content-between">
            ...
            <a class="btn btn-primary btn-sm" href="{{route('admin.language.index')}}"><i class="fas fa-chevron-left"></i> {{ __('Back') }}</a>
            </div>
    </div>
</div>
  ...
  <div class="row">
    ...
    <div class="col-xl-12 col-lg-12">
        ...
        <form class="geniusform" action="{{route('admin.language.update',$data->id)}}" method="POST" enctype="multipart/form-data">
