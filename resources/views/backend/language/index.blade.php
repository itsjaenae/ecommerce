                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <a class="dropdown-item" href="{{ route('admin.language.status',[$data->id,1]) }}">{{ __('Active') }}</a>
                                        <a class="dropdown-item" href="{{ route('admin.language.status',[$data->id,0]) }}">{{ __('Deactive') }}</a>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="action-list">
                                        <a class="btn btn-secondary btn-sm "
                                            href="{{ route('admin.language.edit',$data->id) }}">
