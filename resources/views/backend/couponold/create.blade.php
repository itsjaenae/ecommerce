			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('admin.coupon.store') }}" method="POST"
										...
										<select name="categories[]" class="form-control select2" multiple="" required="">
										  ...
										  @foreach($categories as $category)
											...
											{{-- @foreach($section['categories'] as $category) --}}
											  <option value="{{ $category['id'] }}" @if(in_array($category['id'],array())) selected="" @endif>&nbsp;&nbsp;&nbsp;--&nbsp;&nbsp;{{ $category['name_en']}}</option>
											  @foreach($category['subcategory'] as $subcategory)
												<option value="{{ $subcategory['id'] }}" @if(in_array($subcategory['id'],array())) selected="" @endif>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--&nbsp;{{ $subcategory['name_en']}}</option>
											  @endforeach  
											@endforeach
										  {{-- @endforeach --}}
										</select>
