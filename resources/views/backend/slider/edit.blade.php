    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                ...
                <a class="btn btn-primary btn-sm" href="{{route('admin.slider.index')}}"><i class="fas fa-chevron-left"></i> {{ __('Back') }}</a>
                </div>
        </div>
    </div>
			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('admin.slider.update',$slider->id) }}"
									...
									<div class="form-group">
										...
										<br>
											<img class="admin-img"
												src="{{ $slider->logo ? asset('images/slider_images/'.$slider->logo) : asset('assets/images/placeholder.png') }}"
												alt="No Image Found">
										<br>
									...
									<div class="form-group">
										...
										<br>
											<img class="admin-img"
												src="{{ $slider->photo ? asset('images/slider_images/'.$slider->photo) : asset('assets/images/placeholder.png') }}"
												alt="No Image Found">
										<br>
