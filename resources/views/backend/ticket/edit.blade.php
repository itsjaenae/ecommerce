    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                ...
                <a class="btn btn-primary btn-sm" href="{{route('admin.ticket.index')}}"><i class="fas fa-chevron-left"></i> {{ __('Back') }}</a>
                </div>
        </div>
    </div>
			...
			<div class="card ">
				<div class="card-body">
					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('admin.ticket.update',$ticket->id) }}" method="POST"
                                    ...
                                    <div class="mb-2">
                                        <div class="card">
                                            <div class="card-body d-flex flex-row justify-content-between ">
                                                ...
                                                <a href="{{ route('admin.ticket.status',$ticket->id) }}" class="btn btn-primary btn-sm">{{__('Ticket Close')}}</a>
                                                @else
