			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('admin.category.update',$category->id) }}"
                              ...
                              @method('PUT')   
									...
									<div class="form-group">
										...
										<br>
											<img class="admin-img"
												src="{{ $category->photo ? asset('images/category_images/'.$category->photo) : asset('assets/images/placeholder.png') }}"
												alt="No Image Found">
                                        <br>
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" name="name_en" class="form-control item-name" id="name"
											placeholder="{{ __('Enter Name') }}" value="{{ $category->name_en }}" >
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" name="name_hin" class="form-control item-name" id="name"
											placeholder="{{ __('Enter Name') }}" value="{{ $category->name_hin }}" >
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" name="name_frn" class="form-control item-name" id="name"
											placeholder="{{ __('Enter Name') }}" value="{{ $category->name_frn}}" >
									</div>
								</div>
							</div>
								...
								<div class="row">
									...
									<div class="form-group">
										...
										<input type="text" name="slug_en" class="form-control" id="slug"
											placeholder="{{ __('Enter Slug') }}" value="{{ $category->slug_en }}" >
									</div>
									</div>
									...
									<div class="form-group">
										...
										<input type="text" name="slug_hin" class="form-control" id="slug"
											placeholder="{{ __('Enter Slug') }}" value="{{ $category->slug_hin}}" >
									</div>
									</div>
									...
									<div class="form-group">
										...
										<input type="text" name="slug_frn" class="form-control" id="slug"
											placeholder="{{ __('Enter Slug') }}" value="{{ $category->slug_frn}}" >
									</div>
									</div>
								</div>
