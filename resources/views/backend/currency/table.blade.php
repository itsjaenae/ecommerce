    ...
    <td>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="{{ route('admin.currency.status',[$data->id,1]) }}">{{ __('Enable') }}</a>
              <a class="dropdown-item" href="{{ route('admin.currency.status',[$data->id,0]) }}">{{ __('Disable') }}</a>
            </div>
          </div>
        ...
        <div class="action-list">
            ...
            @if ($data->id != 1)
                <a class="btn btn-danger btn-sm " data-toggle="modal"
                    ...
                    data-href="{{ route('admin.currency.destroy',$data->id) }}">
