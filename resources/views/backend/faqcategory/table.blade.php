    ...
    <td>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="{{ route('admin.fcategory.status',[$data->id,1]) }}">{{ __('Enable') }}</a>
              <a class="dropdown-item" href="{{ route('admin.fcategory.status',[$data->id,0]) }}">{{ __('Disable') }}</a>
            </div>
          </div>
    ...
    <td>
        <div class="action-list">
            <a class="btn btn-secondary btn-sm btn-rounded"
                href="{{ route('admin.fcategory.edit',$data->id) }}">
                <i class="fas fa-edit"></i> {{ __('Edit') }}
            </a>
            <a class="btn btn-danger btn-sm btn-rounded" data-toggle="modal"
                data-target="#confirm-delete" href="javascript:;"
                data-href="{{ route('admin.fcategory.destroy',$data->id) }}">
