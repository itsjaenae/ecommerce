	...
	<div class="card shadow mb-4">
		<div class="card-body">
            ...
            <div class="d-block text-right">
                <a class="btn  btn-primary btn-sm py-1" data-href="{{ route('admin.notifications.clear') }}" href="javascript:;">
            ...
            @if($notf->user_id != null)
                <div class="d-flex align-items-center">
                    <a class="btn btn-sm" href="{{route('admin.notification.delete',$notf->id)}}">
