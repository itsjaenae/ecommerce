    ...
    <div class="row">
     ...
     @endforeach
             <tr>
              ...
              <td>
                <img src="{{asset('images/product_images/'.$carts)}}" width="80" height="65"alt="Product">
              </td>
              ...
              <td class="text-center">
                <a class="remove-from-cart" href="{{route('user.order.delete',$order->id)}}" 
                data-toggle="tooltip" title="Remove item"><i class="icon-x"></i>
              </a></td>
            </tr>
             @endforeach
            </tbody>
