            ...
            <div class="row g-3">
                ...
                <div class="product-card">
                    <div class="product-thumb">
                        ...
                        <img src="{{asset('images/product_images/'.$compaign_item->item->thumbnail)}}" alt="Product">
                        <div class="product-button-group">
                            ...
                            @include('frontend.includes.item_footer',['sitem' => $compaign_item->item])
                        </div>
                    </div>
                    <div class="product-card-body">

                        <div class="product-category"><a href="{{route('front.category').'?category='.$compaign_item->item->category->slug_en}}">
                        ...
                        <h3 class="product-title"><a href="{{route('product.details',$compaign_item->item->slug_en)}}">
