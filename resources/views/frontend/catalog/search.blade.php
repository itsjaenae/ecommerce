            ...
            <aside class="sidebar sidebar-offcanvas position-left"><span class="sidebar-close"><i class="icon-x"></i></span>
              ...
              <section class="widget widget-categories card rounded p-4">
                ...
                <ul id="category_list" class="category-scroll">
                  ...
                  <a class="category_search" href="javascript:;"  data-href="{{$getcategory->slug_en}}">
                    @if(session()->get('language') == 'hindi') {{ $getcategory->name_hin }} 
                    @elseif(session()->get('language') == 'french') {{ $getcategory->name_frn }} 
                    @else {{ $getcategory->name_en }} @endif 
                  </a>
