                    ...
                    <div class="col-xxl-3 col-md-4 col-6">
                        ...
                        <div class="product-thumb">
                            ...
                            <a class="product-button product_compare" href="javascript:;" 
                                data-target="{{route('front.compare.product',$item->id)}}"
                        ...
                        <div class="product-card-body">
                            ...
                            <h3 class="product-title">
                                ...
                                {{ strlen(strip_tags($item->name_frn)) > $name_string_count ? substr(strip_tags($item->name_frn), 0, 38) : strip_tags($item->name_frn) }}
                                @else{{ strlen(strip_tags($item->name_en)) > $name_string_count ? substr(strip_tags($item->name_en), 0, 38) : strip_tags($item->name_en) }}
                                 @endif 
                            </a></h3>
                                        ...
                                        <div class="product-card-body">
                                            ...
                                            <h3 class="product-title">
                                                <a href="{{route('product.details',$item->slug_en)}}">
                                                    ...
                                                    {{ strlen(strip_tags($item->name_frn)) > $name_string_count ? substr(strip_tags($item->name_frn), 0, 38) : strip_tags($item->name_frn) }}
                                                    @else
                                                    {{ strlen(strip_tags($item->name_en)) > $name_string_count ? substr(strip_tags($item->name_en), 0, 38) : strip_tags($item->name_en) }}
                                                     @endif 
                                            </a></h3>
                                            <div class="rating-stars">
                                                {!! renderStarRating($item->reviews->avg('rating')) !!}
