...
class LanguageController extends Controller
{
    ...
    {
        $datas = Language::get();
        return view('backend.language.index',compact('datas'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.language.create',compact('data','lang'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.language.index')->withSuccess(__('Language Added Successfully.'));
    }
    ...
    public function status($id,$status)
    {
        ...
        $data->update();
        return redirect()->route('admin.language.index')->withSuccess(__('Language Updated Successfully.'));
    }
