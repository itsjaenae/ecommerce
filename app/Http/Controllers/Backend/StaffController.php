...
use App\{
    Models\Admin,
    Repositories\Backend\StaffRepository,
...
class StaffController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.staff.index')->withSuccess(__('New User Added Successfully.'));
    }
    ...
    {
        $admin = $staff;
        return view('backend.staff.edit',compact('admin'));
    }
    ...
    public function update(Request $request, Admin $staff)
    {
        ...
        return redirect()->route('admin.staff.index')->withSuccess(__('User Updated Successfully.'));
    }
    ...
    public function destroy(Admin $staff)
    {
        ...
        return redirect()->route('admin.staff.index')->withSuccess(__('User Deleted Successfully.'));
    }
}
