    ...
    public function status($id,$field,$value)
    {
        ...
        if($field == 'payment_status'){
            if($order['payment_status'] == 'Paid'){
                return redirect()->route('admin.order.index')->withErrors(__('Order is already paid.'));
            }
        }
        if($field == 'order_status'){
            if($order['order_status'] == 'Delivered'){
                return redirect()->route('admin.order.index')->withErrors(__('Order is already Delivered.'));
            }
        }
        ...
        return redirect()->route('admin.order.index')->withSuccess(__('Status Updated Successfully.'));
    }
