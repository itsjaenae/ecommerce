...
class TicketController extends Controller
{
    ...
    public function ticket()
    {
        ...
        return view('frontend.user.dashboard.ticket',compact('tickets'));
    }

    public function ticketNew()
    {
        return view('frontend.user.dashboard.ticket-new');
    }

    public function ticketView($id)
    {
        $ticket = Ticket::findOrFail($id);
        return view('frontend.user.dashboard.ticket-view',compact('ticket'));
    }
