...
class CrudGenerator extends Command
{
    ...
    public function handle()
    {
        ...
        'Route::get(\''.'/'.$lower."/datatables', 'Admin".'\\'."{$name}Controller::class,'datatables')->name('admin-{$lower}-datatables');"."\n".     
        'Route::get(\''.'/'.$lower."', 'Admin".'\\'."{$name}Controller::class,'index')->name('admin-{$lower}-index');"."\n".
        'Route::get(\''.'/'.$lower."/create', 'Admin".'\\'."{$name}Controller::class,'create')->name('admin-{$lower}-create');"."\n".
        'Route::post(\''.'/'.$lower."/create', 'Admin".'\\'."{$name}Controller::class,'store')->name('admin-{$lower}-store');"."\n".
        'Route::get(\''.'/'.$lower."/edit/{id}', 'Admin".'\\'."{$name}Controller::class,'edit')->name('admin-{$lower}-edit');"."\n".
        'Route::post(\''.'/'.$lower."/edit/{id}', 'Admin".'\\'."{$name}Controller::class,'update')->name('admin-{$lower}-update');"."\n".
        'Route::delete(\''.'/'.$lower."/delete/{id}', 'Admin".'\\'."{$name}Controller::class,'destroy')->name('admin-{$lower}-delete');"."\n"
        );
